...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/03/01 15:48:23 by fporciel          #+#    #+#             */
/*   Updated: 2024/03/02 15:06:13 by fporciel         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 *
 * This part of the program executes the setting of time.
 */
...
useconds_t	philo_atousec(char *str, size_t len)
{
	if (len == 1)
		return (str[0] - 48);
	else if (len == 2)
