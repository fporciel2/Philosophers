...
/*   Updated: 2024/03/02 15:55:21 by fporciel         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	philo_one(void)
{
	pthread_t		philosopher;
	pthread_mutex_t	fork;
	
	philo_init_mutex(&fork);
	pthread_create(&philosopher, NULL, philo_one, &fork);
	pthread_join(philosopher, NULL);
	philo_destroy_mutex(&fork);
	return (0);
}
